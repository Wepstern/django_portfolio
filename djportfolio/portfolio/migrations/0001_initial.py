# Generated by Django 3.2.8 on 2021-12-02 14:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='portfolio.user')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
                ...
                ('skill', models.ManyToManyField(blank=True, to='portfolio.Skill')),
            ],
            options={
                'ordering': ['-created'],
            },
